...
def init_session_state():
    ...
    if 'current_page' not in st.session_state:
        st.session_state.current_page = "New Record"
    ...
    if records:
        try:
            ...
            if bill_dates:
                ...
                registrations = [random.randint(20, 120) for _ in range(48)]
                revenues = [random.randint(80000, 500000) for _ in range(48)]
    ...
    if records:
        try:
            ...
            if search_term and (search_term):
                ...
                search_columns = ['Company Name', 'ISIN', 'ARN No', 'Email ID', 'COMPANY SPOC', 'Security Type', 'Instrument']
...
with st.sidebar:
    ...
    if st.button("New Record", use_container_width=True):
        st.session_state.page = "New Record"
